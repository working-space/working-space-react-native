...
const Address = ({ navigation: { goBack } }: Props) => {
    ...
    <AddressStyled>
      <AddressSafeArea>
        <Header
          ...
          center={<Typo type="REGULAR_16">주소 설정</Typo>}
          right={
            <Header.Button>
      ...
      {!isFocusSearchKeyword && !searched && (
        <AddressList>
          <AddressItem>
            ...
            <AddressItemText>
              <Typo type="REGULAR_14">서울 관악구 남부순환로186가길 17</Typo>
            </AddressItemText>
          ...
          <AddressItem>
            <LocationIcon width={24} height={24} />
            <AddressItemText>
              <Typo type="REGULAR_14">경기도 과천시 주암동 66-1</Typo>
            </AddressItemText>
